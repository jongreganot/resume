                ...
                <div className="main-background p-5">
                    ...
                    <div className="d-flex flex-row position-relative px-5 h-100">
                        <div className="col-2 d-flex flex-column justify-content-start align-items-start">
                            ...
                            <a className="contact-link mt-4 cursor-pointer" href="https://www.linkedin.com/in/joshuareganot/" target="_blank">
                            ...
                            <a className="contact-link mt-4 cursor-pointer" href="https://www.instagram.com/joshuareganot/" target="_blank">
                        ...
                        <div className="col-10 d-flex flex-column">
                            <div className="d-flex flex-column h-100">
                                ...
                                <Routes>
                                    ...
                                    <Route exact
                                            path="/resume/corporate-projects"
                                            element={<CorporateProject navigateClick={this.navigateClick} />}></Route>
                                    <Route exact
                                            path="/resume/personal-projects"
                                            element={<PersonalProject navigateClick={this.navigateClick} />}></Route>
                                </Routes>
                            </div>
                        </div>
                    </div>
