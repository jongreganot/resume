            ...
            <div className="overflow-y-scroll py-5 px-2">
                <div className="d-flex flex-column gap-5">
                    <div className="d-flex flex-row gap-3">
                        ...
                        <div className="d-lg-flex d-none flex-column align-items-center">
                            <div className="timeline-point animate-this"></div>
                            <div className="timeline-line h-100 animate-this"></div>
                        </div>
                        <div className="col-5 d-lg-flex d-none flex-row">
                    ...
                    <div className="d-flex flex-row gap-3">
                        ...
                        <div className="d-lg-flex d-none flex-column align-items-center timeline-line-container">
                            <div className="timeline-line h-100 animate-this"></div>
                        </div>
                        <div className="col-lg-5 col-12">
