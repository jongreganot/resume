...
import FillerLine from "../components/FillerLine";
...
class CorporateProject extends React.Component {
    ...
    render () {
        return (
            <div className="overflow-y-scroll py-5 px-2">
                <div className="d-flex flex-column">
                    <div className="d-flex flex-row gap-3 mb-md-0 mb-4">
                        ...
                        <div className="col-5 d-md-flex d-none flex-row">
                            <p className="mb-0 fs-small fw-bold animate-this">P R E S E N T</p>
                        </div>
                    </div>
                    <FillerLine timePointLeft="APR 2022" />
                    <div className="d-flex flex-row gap-3 mb-md-0 mb-4">
                        <div className="col-5 d-md-block d-none"></div>
                        <div className="d-md-flex d-none flex-column align-items-center timeline-line-container">
                            <div className="timeline-line h-100 animate-this"></div>
                        </div>
                        <div className="col-md-5 col-12">
                    ...
                    <FillerLine timePointRight="DEC 2021" />
                    <div className="d-flex flex-row gap-3 mb-md-0 mb-4">
                        <div className="col-md-5 col-12">
                    ...
                    <FillerLine timePointLeft="APR 2018" />
                    <div className="d-flex flex-row gap-3 mb-md-0 mb-4">
                        <div className="col-5 d-md-block d-none"></div>
                        <div className="d-md-flex d-none flex-column align-items-center timeline-line-container">
                            <div className="timeline-line h-100 animate-this"></div>
                    ...
                    <FillerLine timePointRight="SEPT 2015" />
                    <div className="d-flex flex-row gap-3 mb-md-0 mb-4">
                        <div className="col-md-5 col-12">
                            <ProjectItem path="M160 0c-17.7 0-32 14.3-32 32s14.3 32 32 32h50.7L9.4 265.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L256 109.3V160c0 17.7 14.3 32 32 32s32-14.3 32-32V32c0-17.7-14.3-32-32-32H160zM576 80a48 48 0 1 0 -96 0 48 48 0 1 0 96 0zM448 208a48 48 0 1 0 -96 0 48 48 0 1 0 96 0zM400 384a48 48 0 1 0 0-96 48 48 0 1 0 0 96zm48 80a48 48 0 1 0 -96 0 48 48 0 1 0 96 0zm128 0a48 48 0 1 0 -96 0 48 48 0 1 0 96 0zM272 384a48 48 0 1 0 0-96 48 48 0 1 0 0 96zm48 80a48 48 0 1 0 -96 0 48 48 0 1 0 96 0zM144 512a48 48 0 1 0 0-96 48 48 0 1 0 0 96zM576 336a48 48 0 1 0 -96 0 48 48 0 1 0 96 0zm-48-80a48 48 0 1 0 0-96 48 48 0 1 0 0 96z"
                                title="Cornell"
                                duration="Apr 2015 to Sept 2015"
                    ...
                    <FillerLine timePointLeft="APR 2015" />
                    <div className="d-flex flex-row gap-3 mb-md-0 mb-4">
                        <div className="col-5 d-md-block d-none"></div>
                        <div className="d-md-flex d-none flex-column align-items-center timeline-line-container">
                            <div className="timeline-line h-100 animate-this"></div>
                    ...
                    <FillerLine timePointRight="DEC 2014" />
                    <div className="d-flex flex-row gap-3 mb-md-0 mb-4">
                        <div className="col-md-5 col-12">
                    ...
                    <FillerLine timePointLeft="APR 2012" />
                    ...
                    <FillerLine timePointRight="OCT 2011" />
                </div>
            </div>
        )
    };
