                    ...
                    <div className="col-10 d-flex flex-column">
                        <div className="d-flex flex-column justify-content-between h-100">
                            <nav className="position-relative">
                                <div className="d-flex flex-row justify-content-between">
                                    <ul className="nav me-auto fs-small fw-bold">
                                        <a href="#" className="nav-item resume-link text-decoration-none pe-5 text-uppercase active" aria-current="page">Home</a>
                                        <a href="#" className="nav-item resume-link text-decoration-none pe-5 text-uppercase">About</a>
                            ...
                            <div className="d-flex flex-column">
                                <p className="mb-0 fs-small">Senior Software Fullstack Developer</p>
                                <p className="mb-0 fs-title">Joshua</p>
                                <p className="mb-5 fs-title">Reganot 
                                    <span className="color-primary">
                                ...
                                <div className="mt-5 pt-2 fs-extra-small color-secondary">
